...
if ($user)
    ...
    echo '<a href="' . $loginUrl . '"><h5>Login</h5></a>';
?>
                    </div>
                </div>
            </div>
...
<?php } else { ?>
    ...
    if (isset($user_info['gender']))
        echo "<b>   GENDER : </b>" . $user_info['gender'];
    if (isset($user_info['birthday']))
        echo "<b>   BIRTHDAY : </b>" . $user_info['birthday'];
    ...
    if (isset($user_info['hometown']))
        echo "<b>   HOMETOWN : </b>" . $user_info['hometown']['name'];
    ?>				
                                        </div>
                                    </div>
                                    <div class="like">
                                    ...
                                    <div class="news-feed">
                                        ...
                                        foreach ($feed['data'] as $news) {
                                            ...
                                            if (isset($news['to']['data']['0']['name']))
                                                $to = $news['to']['data']['0']['name'];
                                            else
                                                $to = NULL;
                                            ...
                                            if (isset($news['comments']['count']))
                                                $comment_count = $news['comments']['count'];
                                            else
                                                $comment_count = 0;

                                            if (isset($news['likes']['count']))
